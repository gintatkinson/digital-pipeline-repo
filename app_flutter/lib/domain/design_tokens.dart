...
class DesignTokenProvider extends InheritedWidget {
  ...
  static DesignTokenRegistry of(BuildContext context) {
    final provider = context.dependOnInheritedWidgetOfExactType<DesignTokenProvider>();
    return provider?.registry ?? DesignTokenRegistry.defaultRegistry;
  }

  @override
  bool updateShouldNotify(DesignTokenProvider oldWidget) {
