...
class CameraController extends ChangeNotifier {
  ...
  static const double minDim_2 = 100.0;
  static const double maxDim_2 = 40000000.0;
  ...
  double _clampDim_2ToTerrain(double lat, double lng, double targetAlt) {
    final double terrainH = _getTerrainHeight(lat, lng);
    final double minAlt = Ellipsoid.wgs84EquatorialRadius + terrainH + minDim_2;
  ...
  void updateCamera(VirtualCamera camera) {
    ...
    final double targetAlt = _clampDim_2ToTerrain(absoluteCamera.dim_0, absoluteCamera.dim_1, absoluteCamera.dim_2);
  ...
  static VirtualCamera _lerpCamera(VirtualCamera a, VirtualCamera b, double t) {
    ...
    final double baseDim_2 = a.dim_2 + (b.dim_2 - a.dim_2) * t;
    final double boostedDim_2 = baseDim_2 + math.sin(t * math.pi) * maxBoost;
  ...
  void pan(Offset delta, [double shortestSide = 800.0]) {
    ...
    final double targetAlt = _clampDim_2ToTerrain(newLat, newLng, _camera.dim_2);
  ...
  void zoom(double scrollDelta) {
    ...
    final double clampedHeightAGL = targetHeightAGL.clamp(minDim_2, maxDim_2);
