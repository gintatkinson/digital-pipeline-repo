...
- A feature is "closed" only when: tests pass, code is merged, solution walkthrough is committed, GitHub issue is closed with a traceability comment, and the parent Epic checklist is updated.
