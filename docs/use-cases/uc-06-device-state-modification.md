...
- [ ] #6 - Device state modifications ([us-06-device-state](https://github.com/gintatkinson/digital-pipeline-repo/blob/main/docs/user-stories/us-06-device-state.md)) (Verifies device state modification capability)
